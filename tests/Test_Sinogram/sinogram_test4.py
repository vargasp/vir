...
def sino_par2hel(sinoP, nRows, nAngs, pitch, transD=0.0, rD=0.0):
    ...
    for i in range(nViews):
        ...
        T, R = proj_orient_TM(rD, transD, center)  
...
sinoHd0C = calib_proj_orient(sinoH_d0.copy(), Views, transD=-transD, pitch=1)
...
sinoHd1C = calib_proj_orient(sinoH_d1.copy(), Views, rD=-rD, pitch=1)
view_sinos(sinoHd1C, sinoH)


"""Dectector offset, Dectector rotation"""    
sinoH_d2 = sino_par2hel(sino, 128, nAngs, 1, transD=transD,rD=rD)
sinoHd2C = calib_proj_orient(sinoH_d2.copy(), Views, transD=-transD, rD=-rD,\
                             pitch=1)
...
sinoH2_d2C = calib_proj_orient(sinoH2_d2.copy(), Views, transD=-transD, rD=-rD,\
                               transX=-trans_X,\
                               rZ=-angY_Z,cenZ_y=center_Z[2],\
                               phi=angY_A,cenA_y=center_A[2],\
                               pitch=1)
